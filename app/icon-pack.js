(() => {
  ...
  function style(){if(document.getElementById('dawoIconPackStyle'))return;const s=document.createElement('style');s.id='dawoIconPackStyle';s.textContent=`
    .dawo-module-icon{width:18px;height:18px;display:inline-flex!important;align-items:center;justify-content:center;color:var(--icon-color);filter:drop-shadow(0 0 5px color-mix(in srgb,var(--icon-color) 45%,transparent));flex:0 0 auto}.dawo-module-icon svg{width:100%;height:100%;fill:none;stroke:currentColor;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round}.tab.active .dawo-module-icon,.side-item.active .dawo-module-icon{filter:drop-shadow(0 0 8px var(--icon-color))}.plugin-nav .tab{gap:7px}.side-item .dawo-module-icon{width:22px;height:22px;margin:auto}.module-card .dawo-module-icon{width:34px;height:34px;margin-bottom:12px}.module-card{--module-color:#20dfff}.module-card .dawo-module-icon{color:var(--module-color);filter:drop-shadow(0 0 8px color-mix(in srgb,var(--module-color) 55%,transparent))}.module-card:hover .dawo-module-icon{transform:scale(1.05)}
    @media(max-width:760px){
      .topbar{grid-template-columns:78px minmax(0,1fr)!important;gap:4px!important;padding:0 6px!important}
      .brand{min-width:68px!important;width:68px!important;padding:2px 4px!important}
      .brand .dawo-keywheel-wrap{width:52px!important;height:52px!important}
      .plugin-nav{display:flex!important;align-items:stretch!important;justify-content:flex-start!important;overflow-x:auto!important;overflow-y:hidden!important;scroll-snap-type:x proximity;-webkit-overflow-scrolling:touch;min-width:0!important}
      .plugin-nav .tab{display:flex!important;align-items:center!important;justify-content:center!important;min-width:44px!important;width:44px!important;flex:0 0 44px!important;padding:0!important;scroll-snap-align:center;border-bottom-width:3px!important}
      .plugin-nav .tab>span:not(.dawo-module-icon):not(#transferBadge){display:none!important}
      .plugin-nav .dawo-module-icon{display:inline-flex!important;width:22px!important;height:22px!important;visibility:visible!important;opacity:1!important}
      .plugin-nav .tab.active .dawo-module-icon{transform:scale(1.08);filter:drop-shadow(0 0 8px var(--icon-color)) drop-shadow(0 0 14px var(--icon-color))}
    }
